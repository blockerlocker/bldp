...
all_versions.insert(0, {"id": "beta_1.0", "entity_list": ["egg"]})
all_versions.insert(0, {"id": "alpha_v1.2.0", "entity_list": ["ghast", "zombified_piglin", "fishing_bobber", "fireball"]})
...
all_versions.insert(0, {"id": "classic_0.24_survival_test", "entity_list": ["creeper", "pig", "skeleton", "zombie", "arrow", "item"]})
