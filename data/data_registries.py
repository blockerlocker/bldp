...
bldp.append_to_bldp_load("execute unless data storage bldp:registry all.items run function bldp:registry/items")
...
bldp.append_to_bldp_load("execute unless data storage bldp:registry all.blocks run function bldp:registry/blocks")
...
bldp.append_to_bldp_load("execute unless data storage bldp:registry all.block_placing_items run function bldp:registry/block_placing_items")
...
bldp.append_to_bldp_load("execute unless data storage bldp:registry all.biomes run function bldp:registry/biomes")

entity_type_list = bldp.get_registry_data(MCVERSION,"entity/type")
...
bldp.append_to_bldp_load("execute unless data storage bldp:registry all.entities run function bldp:registry/entities")
...
bldp.append_to_bldp_load("execute unless data storage bldp:registry all.mobs run function bldp:registry/mobs")
...
bldp.append_to_bldp_load("execute unless data storage bldp:registry all.non_mob_entities run function bldp:registry/non_mob_entities")
