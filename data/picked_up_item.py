...
def main():
    ...
    generate_per_item(item_list,"scoreboard objectives add bldp.picked_up.%(item) minecraft.picked_up:%(item)","bldp/function/picked_up_item/","load.mcfunction")
    generate_per_item(item_list,"scoreboard players reset @s bldp.picked_up.%(item)","bldp/function/picked_up_item/","reset.mcfunction")
    generate_per_item(item_list,"execute if score @s bldp.picked_up.%(item) matches 1.. run data modify storage bldp:picked_up_item out set value %(item)","bldp/function/picked_up_item/","identify.mcfunction")
