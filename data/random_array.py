...
def main():
    ...
    string_to_file("$data modify storage bldp:array_random out set from storage bldp:array_random in[$(value)]","bldp/function/func/array/random","commit.mcfunction")
